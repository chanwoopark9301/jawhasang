...
12. **SW 캐시**: `jip-v{n}` 버전 번호 — CSS/JS 변경 시 반드시 버전 올려야 구 캐시 무효화됨. 현재: `jip-v16`. `index.html`/`/`는 **Network First** 전략 — 새 배포 즉시 최신 HTML 수신, 오프라인만 캐시 폴백. JS·CSS는 Cache First 유지.
